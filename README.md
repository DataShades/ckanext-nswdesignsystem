...
2. Clone the source and install it on the virtualenv
    ...
    git clone https://github.com/LinkDigital/ckanext-nswdesignsystem.git
    cd ckanext-nswdesignsystem
    pip install -e .
	pip install -r requirements.txt

3. Add `nswdesignsystem` to the `ckan.plugins` setting in your CKAN
...
**TODO:** Document any optional config settings here. For example:
	...
	# (optional, default: 24).
	ckanext.nswdesignsystem.some_setting = some_default_value
